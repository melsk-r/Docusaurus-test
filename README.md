...
In de repository [new-gemma-zaken](https://melsk-r.github.io/new-gemma-zaken/)  dat een kopie is van de repository die we in de voorgaand eparagraaf geanalyseerd hebben, is een aantal experimenten gedaan met als doel dichter bij de aan het begin van dit document beschreven voorwaarden te komen.
